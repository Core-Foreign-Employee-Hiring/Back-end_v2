...
@Getter
@Table(
        indexes = @Index(name = "idx_language_skill_snapshot_specification_evaluation_id", columnList = "specification_evaluation_id")
)
public class LanguageSkillSnapshot extends BaseTimeEntity {
    @Id
    @GeneratedValue(strategy = IDENTITY)
    @Column(name = "language_skill_snapshot_id")
    private Long id;
