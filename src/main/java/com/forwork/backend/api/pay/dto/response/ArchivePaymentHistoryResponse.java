...
public record ArchivePaymentHistoryResponse(
    ...
    public static ArchivePaymentHistoryResponse of(Payment payment, PassArchive archive, boolean downloaded) {
        return new ArchivePaymentHistoryResponse(
